...
class MasterHash {
	...
	public static function getXStr() {
		$alph = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789abcdefghijklmnopqrstuvwxyz!@#$&?";
		$str = "";
		for($i = 0; $i < 12; $i++) {
			$str .= $alph[mt_rand(0, 67)];
	...
	public function getObjXStr() { return $this->XStr; }

	public static function _Hash($str, $salt = null) {
	...
	public static function TieString($str = null) {
	...
	public static function UnTieString($str) {
		if(!isset($str) || empty($str) || $str == null) return null;
		$len = strlen($str);
		if($len % 2 == 0) {
